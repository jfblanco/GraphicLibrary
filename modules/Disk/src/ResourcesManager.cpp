...
//    if(this->logManager != nullptr) this->logManager->debug("Destroying ResourcesManager");
}
...
//    if(enableLogManager) {
//        this->logManager->setLogStatusInterface(new LogStatusEnabled());
//    }
//    this->pathToResources = this->configManager->getPropertyAsString("modelPathFolder");
//    this->logManager->info("ResourcesManager Init completed");
}
